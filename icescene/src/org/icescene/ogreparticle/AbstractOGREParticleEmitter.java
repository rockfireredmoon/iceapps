...
import org.icescene.assets.ExtendedMaterial;
import org.icescene.assets.ExtendedMaterialListKey;
import org.icescene.ogreparticle.influencers.AngleInfluencer;
import org.icescene.ogreparticle.influencers.DirectionInfluencer;
import org.icescene.ogreparticle.influencers.InitialColourInfluencer;
import org.icescene.ogreparticle.influencers.InitialSizeInfluencer;
...
public abstract class AbstractOGREParticleEmitter implements OGREParticleEmitter, PropertyBean {
	...
	public Emitter createEmitter(AssetManager assetManager) {
		...
		LOG.info(String.format("   Start Colour Range: %s -> %s", Icelib.toHexNumber(IceUI.fromRGBA(startColour)),
				Icelib.toHexNumber(IceUI.fromRGBA(endColour))));
