...
public class ColourInterpolatorAffector extends AbstractOGREParticleAffector {
        ...
        if (particleTime <= times.get(0)) {
            ...
            for (int i = 0; i < times.size() - 1; i++) {
                if (particleTime >= times.get(i) && particleTime < times.get(i + 1)) {
                    ...
                    p.color.set(
                            (col2.r * particleTime) + (col.r * (1.0f - particleTime)),
    ...
    @Property(label = "Time 0", weight = 20)
    ...
    @Property(label = "Time 1", weight = 40)
    ...
    @Property(label = "Time 2", weight = 60)
    ...
    @Property(label = "Time 3", weight = 80)
    ...
    @Property(label = "Time 4", weight = 100)
    ...
    @Property(label = "Time 5", weight = 120)
