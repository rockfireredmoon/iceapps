...
public class FogFilter2 extends Filter {
	...
	public FogFilter2(FogMode fogMode, ColorRGBA fogColor, float fogDensity, float fogStartDistance,
	...
	protected void initFilter(AssetManager manager, RenderManager renderManager, ViewPort vp, int w, int h) {
		material = new Material(manager, "MatDefs/Filters/AltFog.j3md");
		...
		material.setBoolean("DepthFog", depthFog);
	}
	...
	public void setDepthFog(boolean depthFog) {
		this.depthFog = depthFog;
		if (material != null) {
			// ??
