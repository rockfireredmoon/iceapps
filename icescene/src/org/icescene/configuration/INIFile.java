...
public final class INIFile {
     ...
     */
    public void setFloatProperty(String pstrSection, String pstrProp,
            float pfltVal, String pstrComments) {
        INISection objSec = null;
    ...
    private void loadFile() throws IOException {
        load(new FileInputStream(this.mstrFile));
    }
