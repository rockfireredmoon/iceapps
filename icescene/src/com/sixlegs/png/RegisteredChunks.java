...
public class RegisteredChunks
{
	...
	private static byte[] defaultPaletteAlpha;
    ...
    throws IOException
    {
        ...
        case PngConstants.COLOR_TYPE_PALETTE:
            ...
            if(defaultPaletteAlpha != null) {
				props.put(PngConstants.PALETTE_ALPHA, defaultPaletteAlpha);
			}
    ...
    public static byte[] getDefaultPaletteAlpha() {
		return defaultPaletteAlpha;
	}

	public static void setDefaultPaletteAlpha(byte[] defaultPaletteAlpha) {
		RegisteredChunks.defaultPaletteAlpha = defaultPaletteAlpha;
	}
