...
void main(){
   ...
   #ifdef ANIM
	texCoord = vec2(inTexCoord[0] + mod((g_Time * m_ScrollAnim1X * m_GlobalAnimSpeed) + m_ScrollX , 1),
	        inTexCoord[1] + mod((g_Time * m_ScrollAnim1Y * m_GlobalAnimSpeed ) + m_ScrollY , 1));
	#else
   texCoord = inTexCoord;
   #endif
...
//   lightVec.w = fract(g_LightDirection.w);
   ...
   lightColor.w = 1.0;
      ...
      DiffuseSum  =  m_ColorMap  * lightColor;
